	...
	"openssl" = @{
		...
		Files = @{
			...
			"1.0.1u" = @{
				...
				Url  = "http://www.openssl.org/source/openssl-1.0.1u.tar.gz";
				Hash = "4312B4CA1215B6F2C97007503D80DB80D5157F76F8F7D3FEBBE6B4C56FF26739";
			};
			"1.1.1m" = @{
				File = "openssl-1.1.1m.tar.gz";
				Url  = "http://www.openssl.org/source/openssl-1.1.1m.tar.gz";
	...
	wxwidgets = @{
		...
		Files = @{
			"2.8.12" = @{
				...
				Url  = "http://github.com/wxWidgets/wxWidgets/releases/download/v2.8.12/wxMSW-2.8.12.zip";
				Hash = "307D713D8AFFBED69A89418D9C9073193AADFEF4B16DA3D8EF68558A9F57AE88";
			};
			"3.0.5" = @{
				File = "wxWidgets-3.0.5.7z";
				Url  = "http://github.com/wxWidgets/wxWidgets/releases/download/v3.0.5/wxWidgets-3.0.5.7z";
				Hash = "33D7E9327CD0192CCC5D69F78C4A98C3C17F190D94F99F1B1C89BD4A47A1D5DC";
			};
			"3.2.0" = @{
				File = "wxWidgets-3.2.0.7z";
				Url  = "http://github.com/wxWidgets/wxWidgets/releases/download/v3.2.0/wxWidgets-3.2.0.7z";
	...
	expat = @{
		...
		Files = @{
			"2.1.0" = @{
				...
				Url  = "http://sourceforge.net/projects/expat/files/expat_win32/2.1.0/expat-win32bin-2.1.0.exe/download";
				Hash = "FC264700310B882290D69695E576CC75479F3B0D9E144B6CB816864BBA0C2F33";
			};
			"2.1.1" = @{
				File = "expat-win32bin-2.1.1.exe";
				Url  = "http://sourceforge.net/projects/expat/files/expat_win32/2.1.1/expat-win32bin-2.1.1.exe/download";
				Hash = "EBF438297B52CA617BF0E00D264CC7A998A50534D023466AD66F4BD66359B534";
			};
			"2.2.8" = @{
				File = "expat-win32bin-2.2.8.exe";
				Url  = "http://sourceforge.net/projects/expat/files/expat_win32/2.2.8/expat-win32bin-2.2.8.exe/download";
				Hash = "48DAEC6F027411C4B8D04499366CBD724C05AAA4F09D02B5A822A3FE41FA9335";
			};
			"2.5.0" = @{
				File = "expat-win32bin-2.5.0.zip";
				Url  = "http://sourceforge.net/projects/expat/files/expat_win32/2.5.0/expat-win32bin-2.5.0.zip/download"
	...
	$downloads["sqlite3"] = @{
		...
		Files = @{
			"3440200" = @{
				...
				Url  = "http://sqlite.org/2023/sqlite-amalgamation-3440200.zip";
